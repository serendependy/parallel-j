...
a distributed memory parallel environment, such as MPI\cite{mpi}.
...
because it allows programmers take existing functions and, in an inherently data parallel fashion, 
