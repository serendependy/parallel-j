...
\noindent Incrementing numeric values always applies to scalars, so the function \texttt{increment} always gives the same result, 
...
as well as repeated applications of the rank operator, is given below.
