...
Taking the same set of parallel problems, we show both how this library allows for easily extending these problems into higher dimensions and 
...
This is given in the appendix, and includes a partial lexer for the J programming language written in Scala. % TODO add appendix
