...
Many tools have already been developed to help programmers exploit data parallelism % TODO cite OpenMP, dph
easily and safely (i.e., with reduced risk of race conditions or program crashes). %TODO citation
...
Also to be included was a proposal and implementation of a new \textit{foreign} operator, 
called the \textit{parallel operator} and spelled\ttfamily (111 !:)\normalfont , % TODO change this 
