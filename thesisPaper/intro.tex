...
In order for these applications to achieve good performance, it is often the case that programmers must exploit any and all concurrency in the application through different approaches to parallel programming.
...
this activity is tedious in the trivial cases and prone to unnecessary error 
...
A proof-of-concept is needed to demonstrate that the notion of function rank % TODO what to call shape vectored arrays?
