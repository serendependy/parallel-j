...
that has many of the same advantages as Repa.\cite{dph}, % TODO cite SA-C
...
In contrast, the C++ library Boost.MultiArray is a library for a general purpose and widely used programming language. % TODO cite
